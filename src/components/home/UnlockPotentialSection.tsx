  ...
  return (
    <div className="flex flex-col w-full potential">
      <section className="relative h-[900px] flex flex-col items-center justify-center text-center py-12 w-full">
        <div className="w-[70%] mx-auto relative z-10 mt-52">
          {/* Background Image */}
          ...
          {/* Text Content */}
          <div className="relative z-20 py-16 px-8 rounded-xl">
            <div className="mb-4">
            ...
            <button className="bg-purple-500 text-white font-semibold px-6 py-3 rounded-lg">
              Join Us
            </button>
          </div>
        </div>
